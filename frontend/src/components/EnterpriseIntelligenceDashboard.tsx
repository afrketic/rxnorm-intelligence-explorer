  ...
  return (
    <section className="space-y-4">
      <div className="rounded-3xl border border-blue-900/40 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950/70 p-6 text-white shadow-sm">
        <p className="text-xs font-black uppercase tracking-[0.28em] text-cyan-300">Enterprise Decision Layer</p>
        <h2 className="mt-2 text-3xl font-black tracking-tight">Enterprise Intelligence</h2>
        <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-300">
          Portfolio ranking, recommendation strategy, deployment readiness, validation, publication, and production decision support.
        </p>
      </div>

      <SafeCardBoundary title="Enterprise Healthcare Importance">
