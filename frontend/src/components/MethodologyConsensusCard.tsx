...
function tierStyle(tier?: string) {
  ...
  if (normalized.includes('exceptional')) return 'border-slate-300 bg-slate-950 text-white';
  ...
  if (normalized.includes('weak')) return 'border-amber-200 bg-amber-50 text-amber-900';
      ...
      {!loading && !error && payload && (
        <div className="px-7 pb-7">
            ...
            <ChartCard title="Methodology Radar" subtitle="Visual agreement across four independent scoring models.">
              <ResponsiveContainer width="100%" height={300}>
                <RadarChart data={scoreRows}>
                  ...
                  <Tooltip />
                  <Radar dataKey="score" name="Score" fillOpacity={0.25} />
                </RadarChart>
              </ResponsiveContainer>
            </ChartCard>
          ...
          <div className="mt-5 rounded-3xl border border-slate-200 bg-slate-50 p-5">
            <h3 className="text-base font-black text-slate-950">Consensus Interpretation</h3>
